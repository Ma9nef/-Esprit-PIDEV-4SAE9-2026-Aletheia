...
@Service
public class InstructorLessonServiceImpl implements InstructorLessonService {

    private final LessonCoreService lessonCoreService;
    private final LessonMapper lessonMapper;

    public InstructorLessonServiceImpl(LessonCoreService lessonCoreService, LessonMapper lessonMapper) {
