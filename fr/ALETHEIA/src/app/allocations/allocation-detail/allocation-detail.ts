// src/app/allocations/allocation-detail/allocation-detail.component.ts
...
@Component({
    ...
    templateUrl: './allocation-detail.html', // Correction: .component.html
    styleUrls: ['./allocation-detail.css'] // Correction: .component.css
})
