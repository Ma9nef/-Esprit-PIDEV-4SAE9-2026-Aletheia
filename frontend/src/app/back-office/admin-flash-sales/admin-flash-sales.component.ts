  ...
  template: `
    <div class="admin-flash-sales">
      <div class="page-header">
        ...
        <a routerLink="/back-office/admin/flash-sales/new" class="btn-primary">+ New Flash Sale</a>
      </div>
      ...
      <div class="flash-sales-grid" *ngIf="!loading && flashSales.length > 0">
        <div class="fs-card" *ngFor="let fs of flashSales">
          ...
          <div class="fs-actions">
            <a [routerLink]="['/back-office/admin/flash-sales', fs.id]" class="btn-edit">Edit</a>
