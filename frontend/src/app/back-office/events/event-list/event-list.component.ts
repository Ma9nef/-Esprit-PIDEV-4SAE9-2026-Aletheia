...
import { EventService } from '../event.service'; // Correction: event.service (pas event)
...
export class EventListComponent  implements OnInit {
  ...
  navigateToCreate(): void {
    this.router.navigate(['/back-office/events/new']);
  }

  navigateToEdit(id: number): void {
    this.router.navigate(['/back-office/events/edit', id]);
  }
