...
import { EventFormComponent } from './back-office/events/event-form/event-form.component';
import { EventListComponent } from './back-office/events/event-list/event-list.component';
import { EventListComponente } from './front-office/events/event-list/event-list.component';
import { EventDetailComponent } from './front-office/events/event-detail/event-detail.component';
...
{ path: 'EventListComponente', component: EventListComponente },

  { path: 'crude/form', component: EventFormComponent },
  { path: 'crude/liste', component: EventListComponent },
