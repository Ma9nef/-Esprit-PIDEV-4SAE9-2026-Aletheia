...
export class LibraryService {
  ...
  uploadProductFile(file: File): Observable<FileUploadResponse> {
    const formData = new FormData();
    formData.append('file', file);
    return this.http.post<FileUploadResponse>(`${this.fileUrl}/upload/product`, formData);
  }

  uploadCoverImage(file: File): Observable<FileUploadResponse> {
    const formData = new FormData();
    formData.append('file', file);
    return this.http.post<FileUploadResponse>(`${this.fileUrl}/upload/cover`, formData);
  }
